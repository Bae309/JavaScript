...
// 전개구문  ...변수명
// 나머지 매개변수로 사용할 때 
// 매개변수를 고정하기 어려울 경우에 전개구문으로 변수 하나 지정
...
// 기존 배열 연결 방식 : concat()
console.log("animalrhk fruits 연결 : ", animal.concat(fruits));
...
// ES2015이후에는 [](대괄호)를 사용할 수 있다.
const book = {
    title : 'JavaScript',
    pages : 650,
}
// "published date"프로퍼티 추가
// book.published date = "2023-11"; // syntax Error -> 띄어쓰기 때문에

// [] 표기법으로 사용하면 가능. []안에는 문자열로 작성해야 함
book["published date"] = "2023-11";
console.log("book : ", book);

// ES2015부터는 함수나 계산식을 프로퍼티 이름으로 사용가능
function fn() {
...
// 프롬포트 창으로 입력 받아 그 값을 프로퍼티로 사용하는 경우.
// 이때 생성자 함수로 객체를 정의하여 저장할 수 있다.
...
/*
    ...
    this.name = name
        생성자 함수 내부에서 사용됨.
        객체의 매서드나 속성을 초기화하는데 사용
        생성자 함수를 통해 객체를 만들때 주로 사용
*/

// 위 코드에서 객체 정의할때 변수와 프로퍼티 이름이 같다면
// 줄여서 사용가능하다.
function makeUser(name,age) {
    return {
        name,
