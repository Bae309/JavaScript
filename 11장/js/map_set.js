...
// set() 메서드를 여러번 쓰기 귀찮을때, 연결해서 사용 가능
bag.set("type","mini").set("propose","daily");
console.log(bag);
...
for (let result of language.values()) {
    console.log(result);
}